...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function handleKeyInput(e, objectExist) {
      var dir;
      console.log(e); // if (e.keyCode >= 37 && e.keyCode <= 40) {
      //   dir = DIRECTIONS[e.key];
      // } else {
      //   return;
      // }

      dir = _setup.DIRECTIONS[e];
...
var Ghost = /*#__PURE__*/function () {
  function Ghost() {
    ...
    this.pos = startPos;
    this.dir = _setup.DIRECTIONS.Right;
    this.speed = speed;
    this.timer = 0;
    this.isScared = false;
    this.rotation = false;
...
function gameLoop(pacman, ghosts) {
  // console.log('works');
  // let move = document.getElementById('prediction').textContent;
  // pacman.handleKeyInput(move, gameBoard.objectExist);
  // ghosts = [
  ...
  } // Change ghost scare mode depending on the power pill
...
function startGame() {
  ...
  gameBoard.addObject(287, [_setup.OBJECT_TYPE.PACMAN]); // const inputF = document.getElementById('prediction');
  // inputF.addEventListener('change', (e) => {
  //   console.log(e);
  //   pacman.handleKeyInput(e, gameBoard.objectExist);
  // });
  // setInterval(pacman.handleKeyInput(inputF, gameBoard.objectExist), 10);
  // $('#prediction').on('input change', function () {
  //   console.log('e');
  //   pacman.handleKeyInput(
  //     document.getElementById('prediction').value,
  //     gameBoard.objectExist
  //   );
  // });

  setInterval(function () {
    var move = document.getElementById('prediction').textContent;
    pacman.handleKeyInput(move, gameBoard.objectExist);
  }, 10);
